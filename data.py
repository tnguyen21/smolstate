...
class DataConfig:
    ...
    @staticmethod
    def update_model_config_with_data_dims(model_config: Dict[str, Any], data_dims: Dict[str, int]) -> Dict[str, Any]:
    ...
    @staticmethod
    def create_decoder_config(data_dims: Dict[str, int], model_kwargs: Dict[str, Any]) -> Dict[str, Any]:
